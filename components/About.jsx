      ...
      <Grid id='about'>
        ...
        <Row className='show-grid' style={internals.style}>
          <Col xs={12} sm={6}>
            ...
            <h5>
              <p>
                It all started in the attic of a big colonial on Norwood Street in Deering Center - Portland, Maine.
              </p>
              <p>
          ...
          <Col xs={12} sm={6}>
            ...
            <h5>
              ...
              <p>The release show was booked at a bar close to my heart, called Slainte. It was probably my favorite show; as
